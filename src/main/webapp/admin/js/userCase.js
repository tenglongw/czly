             ...
             if (data.status == 1){
            	 ...
            	 if (userCaseList == null || userCaseList.length == 0){
            		 ...
            		 for (var index in userCaseList){
                		 ...
                		 userCaseHtml += "<tr><td>"+userCase.title+"</td><td>"+userCase.description+"</td><td>"+userCase.brand+"</td>";
