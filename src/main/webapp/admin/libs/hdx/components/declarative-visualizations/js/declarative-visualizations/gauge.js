define([
    ...
    return function (element) {
      ...
      function updateViz() {
        ...
        (data.threshold !== null) ? tickCircle.attr('display', 'visible').attr('transform', function (d, i) {
          return 'rotate(' + (180 * data.threshold / (data.max - data.min)) + ')'
        }) : tickCircle.attr('display', 'none');
