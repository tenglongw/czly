define([
    ...
    return function (element, opt) {
      ...
      function drawAxes() {
        ...
        // draw axes
        var axes = g.selectAll(".axis").data(axisData, function (d) {
          return d.id;
        });
        axes.enter().append("g")
          .attr("class", "axis")
          .attr("transform", function (d) {
            return (d.id === 'month-axis') ? "translate(" + month_padding[0] + "," + month_padding[1] + ")" : "translate(" + year_padding[0] + "," + year_padding[1] + ")";
          })
          .attr("id", function (d) {
            return d.id;
          });
